...
ALLOWED_DOMAINS = {
    "mi.com"       : ["app.mi.com"],
    "appchina.com" : ["www.appchina.com",],
    "hiapk.com"    : ["apk.hiapk.com",],
    "anzhi.com"    : ["www.anzhi.com",],
    "android.d.cn" : ["android.d.cn",],
    "mumayi.com"   : ["www.mumayi.com",],
...
SCRAPE_RULES = {
    ...
    "name_xpath" : {
        "mi.com"       : "//div[@class='intro-titles']/h3/text()",
        "appchina"     : "//h1[@class='app-name']/text()",
        "hiapk"        : "//*[@id='appSoftName']/text()",
        "anzhi"        : "//div[@class='title']/h3/text()",
        "mumayi"       : "//*[@class='iappname hidden fl']/text()",
    },
    "type_xpath" : {
        "mi.com"       : "//p[@class='special-font action']/text()",
        "appchina"     : "//*[@class='intro app-other-info-intro']/p[6]/text()",
        "hiapk"        : "//a[@class='detail_right_type']/span/text()",
        "anzhi"        : "//*[@id='detail_line_ul']/li[1]/text()",
        "mumayi"       : "//*[@class='istyle fl']/li[2]/text()",
    },
    "size_xpath" : {
        "mi.com"       : "//ul[@class=' cf']/li[2]/text()",
        "appchina"     : "//*[@class='intro app-other-info-intro']/p[2]/text()",
        "hiapk"        : "//*[@id='appSize']/text()",
        "anzhi"        : "//*[@id='detail_line_ul']/li[4]/span/text()",
        "mumayi"       : "//*[@class='istyle fl']/li[4]/text()",
    },
    "description_xpath" : {
        "mi.com"       : "//p[@class='pslide'][1]/text()",
        "appchina"     : "//*[@class='main-info']/p[@class='art-content']/text()",
        "hiapk"        : "//*[@id='softIntroduce']/text()",
        "anzhi"        : "//div[@class='app_detail_infor'][1]/p/text()",
        "mumayi"       : "//div[@class='ibox']/p/text()",
    },
    "version_xpath" : {
        "mi.com"       : "//ul[@class=' cf']/li[4]/text()",
    },
    "time_xpath" : {
        "mi.com"       : "//ul[@class=' cf']/li[6]/text()",
    },
    "versionInfo_xpath" : {
        "mi.com"       : "//p[@class='pslide'][2]/text()",
    },
    "custom_parser" : {
        "anzhi" : "parse_anzhi",
    },
